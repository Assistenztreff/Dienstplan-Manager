...
// Mobile Viewport – MonthGrid zeigt bei 400 px den kompakten Modus mit
// Abwesenheits-Kategorie-Streifen und countLabel ("N Abw.").
...
test("Dienstplan Mobil – Sommerzeit-Umstellungstag (29. März): Abwesenheit erscheint auf dem 29., nicht dem 28.", async ({
  ...
  try {
    ...
    await expect(cell29).toContainText("Abw.", { timeout: 10_000 });
