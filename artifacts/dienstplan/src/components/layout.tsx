  ...
  return (
    <div className="min-h-screen bg-background flex flex-col md:flex-row font-sans text-foreground">
      ...
      <header className="md:hidden flex items-center justify-between p-4 border-b bg-card">
        <h1 className="font-serif text-xl font-semibold text-primary">Dienstplan PA</h1>
        <Sheet>
          ...
          <SheetContent side="left" className="w-64 p-4">
            <h2 className="font-serif text-lg font-semibold text-primary mb-6">Dienstplan PA</h2>
      ...
      <aside className="hidden md:flex flex-col w-64 border-r bg-card p-6">
        <h1 className="font-serif text-2xl font-semibold text-primary mb-8 px-2">Dienstplan PA</h1>
