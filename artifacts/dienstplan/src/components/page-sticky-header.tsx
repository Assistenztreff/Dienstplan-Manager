...
export function PageStickyHeader({
  ...
  return (
    <div data-dienstplan-header className="sticky top-0 z-40 -mx-2 -mt-4 mb-1 border-b border-border/40 bg-white/95 px-2 py-3 backdrop-blur md:-mx-6 md:-mt-6 md:px-6">
      {stacked ? (
