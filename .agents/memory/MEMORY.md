...
- [E2E dev auto-login](e2e-dev-auto-login.md) — in DEV the web app auto-logs-in as admin via /api/auth/dev-login, so /login never shows a form; UI login helpers must tolerate the redirect or they hang on #email.
